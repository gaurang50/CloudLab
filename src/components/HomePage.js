...
const theme = createTheme({
  ...
  components: {
    ...
    MuiCard: {
      styleOverrides: {
        root: {
          borderRadius: '15px', // Rounded corners for cards
...
const events = [
  ...
  { title: 'AI & Machine Learning Expo', date: 'August 11, 2024', icon: <ScheduleIcon />, description: 'Dive into the future with our AI and machine learning expo.', location: 'Convention Center', action: 'View Details' }, // Updated to ScheduleIcon
              ...
              <Card sx={{ 
                ...
                <CardActionArea onClick={() => handleExpandClick(index)}>
                  <CardContent sx={{ 
                    ...
                    <Box sx={{ textAlign: 'center', mb: 1 }}> {/* Center-align text */}
