...
import backgroundImage from './bg2.jpg'; // Ensure this is the correct path to your image file
  ...
  return (
    <Container component="main" maxWidth="false" disableGutters>
      ...
      <Grid container style={{ minHeight: '100vh' }}>
        <Grid item xs={12} sm={6} sx={{ backgroundImage: `url(${backgroundImage})`, backgroundSize: 'cover', backgroundPosition: 'center' }} />
        <Grid item xs={12} sm={6} component={Paper} elevation={6} square sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center', padding: '40px' }}>
          <Box
            sx={{
              display: 'flex',
